...
public class blueNoGateAuto12Balls implements Auto{
    ...
    public Command getAutonomousCommands(RobotContainer robotContainer) {
        ...
        sequence.addCommands(AutoUtils.BlueSecondLineDriveToShortPoseAndShot(robotContainer,bluePositions.LINE_2_ENDING,1800));
        ...
        Command driveToThirdLine = robotContainer.driveSubsystem.followPath(
                ...
                new Translation2d[]{new Translation2d(1.0,-2.0)},   //need
